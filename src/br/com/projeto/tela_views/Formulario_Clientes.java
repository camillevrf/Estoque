...
public class Formulario_Clientes extends javax.swing.JFrame {
    ...
    public void listar() {
        ...
        List<Clientes> lista = dao.listarClientes(); //criando uma lista de clientes que vai receber o listar Clintes, onde retorna a lista
        DefaultTableModel dados = (DefaultTableModel) TabelaClientes.getModel(); //criação do objeto que vai armazenar os dados dessa lista para exibição na tabela de clientes
        dados.setNumRows(0); //limpa os dados

        for (Clientes c : lista) { //para cada item da lista vai criar um obj chamado c 
    ...
    private void initComponents() {
        ...
        TabelaClientes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CÓDIGO", "NOME", "RG", "CPF", "E-MAIL", "TELEFONE", "CELULAR", "CEP", "ENDEREÇO", "NÚMERO", "COMPLEMENTO", "BAIRRO", "CIDADE", "UF"
            }
        ));
    ...
    private void TabelaClientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabelaClientesMouseClicked
        ...
        jTextcod.setText(TabelaClientes.getValueAt(TabelaClientes.getSelectedRow(), 0).toString());
        jTextNome.setText(TabelaClientes.getValueAt(TabelaClientes.getSelectedRow(), 1).toString());
        jFrg.setText(TabelaClientes.getValueAt(TabelaClientes.getSelectedRow(), 2).toString());
        jFcpf.setText(TabelaClientes.getValueAt(TabelaClientes.getSelectedRow(), 3).toString());
        jTextEmail.setText(TabelaClientes.getValueAt(TabelaClientes.getSelectedRow(), 4).toString());
        jTel.setText(TabelaClientes.getValueAt(TabelaClientes.getSelectedRow(), 5).toString());
        jCel.setText(TabelaClientes.getValueAt(TabelaClientes.getSelectedRow(), 6).toString());
        jFcep.setText(TabelaClientes.getValueAt(TabelaClientes.getSelectedRow(), 7).toString());
        jendereco.setText(TabelaClientes.getValueAt(TabelaClientes.getSelectedRow(), 8).toString());
        jTnum.setText(TabelaClientes.getValueAt(TabelaClientes.getSelectedRow(), 9).toString());
        jTcomplem.setText(TabelaClientes.getValueAt(TabelaClientes.getSelectedRow(), 10).toString());
        jTbairro.setText(TabelaClientes.getValueAt(TabelaClientes.getSelectedRow(), 11).toString());
        jTcidade.setText(TabelaClientes.getValueAt(TabelaClientes.getSelectedRow(), 12).toString());
